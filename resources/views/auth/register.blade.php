<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-select-input :options="['buyer' => 'Buyer', 'seller' => 'Seller']" default_option_label="Select Type .." id="type" class="block mt-1 w-full" name="type" :value="old('type')" required autocomplete="type" />
